...
<Steps>
  <Step title="Read the extension contract">
    Start with the [Extension API v3](https://github.com/azure06/clipsx/blob/main/docs/EXTENSION_API_V3.md)
...
- Automatic transformations store durable results on their source clip. They never replace the system clipboard.
- The desktop and package tooling use the v3 contract only.
...
<Card title="Build Rewrite" icon="wand-sparkles" href="/rewrite-extension">
  Follow the complete durable transformation tutorial.
</Card>
