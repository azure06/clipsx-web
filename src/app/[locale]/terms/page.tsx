...
export default function TermsPage({
  ...
  return (
    <div className="py-24 px-4 sm:px-6">
      <div className="mx-auto max-w-3xl prose prose-sm prose-gray dark:prose-invert">
        <h1 className="font-heading text-4xl font-black text-gray-900 dark:text-white">{t('title')}</h1>
        <p className="text-gray-600 dark:text-gray-500">{t('last_updated')}</p>
        ...
        <h2 className="text-gray-900 dark:text-white">2. License</h2>
        <p className="text-gray-700 dark:text-gray-400">
        ...
        <h2 className="text-gray-900 dark:text-white">3. Subscriptions and Billing</h2>
        <p className="text-gray-700 dark:text-gray-400">
        ...
        <h2 className="text-gray-900 dark:text-white">4. Acceptable Use</h2>
        <p className="text-gray-700 dark:text-gray-400">
        ...
        <h2 className="text-gray-900 dark:text-white">6. Limitation of Liability</h2>
        <p className="text-gray-700 dark:text-gray-400">
