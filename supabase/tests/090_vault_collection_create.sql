...
select ok(to_regprocedure('private.create_vault_collection(uuid,uuid,uuid,uuid,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,uuid,bytea,bytea,bytea,bytea,uuid,bytea,bytea,bytea,jsonb)') is not null, 'private collection-create transaction exists');
...
select ok(not has_function_privilege('authenticated', 'private.create_vault_collection(uuid,uuid,uuid,uuid,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,bytea,uuid,bytea,bytea,bytea,bytea,uuid,bytea,bytea,bytea,jsonb)', 'execute'), 'browser roles cannot invoke collection creation directly');
