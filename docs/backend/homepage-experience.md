...
destinations. The header groups Product and Developers destinations, keeps Docs
and Pricing as direct links, and includes account access, a Get ClipsX action,
and a GitHub-mark repository link; its star count is fetched after hydration and
